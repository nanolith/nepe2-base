...
/**
 * \brief The transformers_register function is generated by the build script,
 * and registers all transformer implementations with the transformer registry.
 *
 * \returns a status code indicating success or failure.
 *      - STATUS_SUCCESS on success.
 *      - a non-zero error code on failure.
 */
status FN_DECL_MUST_CHECK transformers_register();
